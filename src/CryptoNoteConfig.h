...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3acb50; //Public Address starts with "btac"
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(2100000000000000); //21mil Coins
